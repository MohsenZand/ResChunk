...
if __name__ == '__main__':
    ...
    reps = ['aa']        # ['aa', 'rotmat', 'quat']
    dbs = ['cmu', 'h36m']    # ['cmu', 'h36m', 'amass']
    ...
    for db in dbs:
        ...
        for rep in reps:
            if db == 'h36m':
                ...
                RAW_AMASS_dir = 'PATH'
                window_size_train = 16  # 3 seconds
                window_size_test = 45  
                window_stride = 1  
            ...
            _ = process_split(db, train_data, train_ids, os.path.join(data_dir, rep, 'training'), n_tfs, compute_stats=False, create_windows=(window_size_train, window_stride))
            ...
            _ = process_split(db, valid_data, valid_ids, os.path.join(data_dir, rep, 'validation'), n_tfs, compute_stats=False, create_windows=(window_size_test, window_stride))
            ...
            _ = process_split(db, test_data, test_ids, os.path.join(data_dir, rep, 'test'), n_tfs, compute_stats=False, create_windows=(window_size_test, window_stride))
